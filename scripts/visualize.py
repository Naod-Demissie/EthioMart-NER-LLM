...
def plot_word_cloud(df, language=None):
    ...
    If language is 'amharic', it excludes English text when plotting the word cloud.
    If language is 'english', it excludes Amharic text.
    If language is not specified, it uses all messages (both Amharic and English).
    """
